...
public class I18n {
  ...
  public I18n(Planecart plugin) {
    ...
    URL[] urls;
    try {
      URL[] localurls = {plugin.getDataFolder().toURI().toURL()};
      urls = localurls;
  ...
  public static String _(final String key, final Object... params) {
    ...
    if(params.length == 0) {
      return ChatColor.translateAlternateColorCodes(COLOR_ESCAPE, instance.translate(key));
    } else {
      return ChatColor.translateAlternateColorCodes(COLOR_ESCAPE, instance.format(key, params));
    }
  }
